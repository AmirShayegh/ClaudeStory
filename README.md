...
### 4. Restart Claude Code, then type:
...
**Tickets** are planned work - features, tasks, refactors. **Issues** are discovered problems - bugs, inconsistencies, gaps. **Notes** are unstructured brainstorming - ideas, design thinking, explorations. **Handovers** capture what each session accomplished so the next one picks up seamlessly.
...
Measured on a real project with 82 tickets, 20 handovers, and 10 phases:
